...
class BusinessesControllerTest < ActionController::TestCase
  ...
  test "should create business" do
    assert_difference('Business.count') do
      post :create, business: { Description: @business.Description, Name: @business.Name, Phone: @business.Phone }
    end
  ...
  test "should update business" do
    put :update, id: @business, business: { Description: @business.Description, Name: @business.Name, Phone: @business.Phone }
    assert_redirected_to business_path(assigns(:business))
  end
